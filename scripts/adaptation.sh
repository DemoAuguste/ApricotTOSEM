...
for i in {1..5}
do
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m resnet20 -d cifar100 -v $i -s 1 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m mobilenet -d cifar100 -v $i -s 1 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m resnet32 -d cifar100 -v $i -s 1 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m mobilenetv2 -d cifar100 -v $i -s 1 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m densenet -d cifar100 -v $i -s 1 -a binary
done

for i in {1..5}
do
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m resnet20 -d cifar100 -v $i -s 2 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m mobilenet -d cifar100 -v $i -s 2 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m resnet32 -d cifar100 -v $i -s 2 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m mobilenetv2 -d cifar100 -v $i -s 2 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m densenet -d cifar100 -v $i -s 2 -a binary
done

for i in {1..5}
do
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m resnet20 -d cifar100 -v $i -s 3 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m mobilenet -d cifar100 -v $i -s 3 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m resnet32 -d cifar100 -v $i -s 3 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m mobilenetv2 -d cifar100 -v $i -s 3 -a binary
    CUDA_VISIBLE_DEVICES=2 python $adaptation_path -m densenet -d cifar100 -v $i -s 3 -a binary
done
