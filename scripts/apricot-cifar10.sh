...
for i in {11..15}
do
  CUDA_VISIBLE_DEVICES=1 python3 $file_path -m resnet20 -d cifar10 -v $i -s 2
  CUDA_VISIBLE_DEVICES=1 python3 $file_path -m resnet32 -d cifar10 -v $i -s 2
  CUDA_VISIBLE_DEVICES=1 python3 $file_path -m mobilenet -d cifar10 -v $i -s 2
  CUDA_VISIBLE_DEVICES=1 python3 $file_path -m mobilenetv2 -d cifar10 -v $i -s 2
  CUDA_VISIBLE_DEVICES=1 python3 $file_path -m densenet -d cifar10 -v $i -s 2
done
