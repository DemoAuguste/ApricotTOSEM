import numpy as np
from .distance_metrics import measure_distance
...
def select_next_inputs(bug_fix_data,
    ...
    if for_underfitting:  
        ...
        targets_x = candidate_samples_x[sorted_scores[-num_target_samples:]].reshape(-1, 32, 32, 3) 
        targets_y = candidate_samples_y[sorted_scores[-num_target_samples:]]
        remainder_x = candidate_samples_x[sorted_scores[:-num_target_samples]].reshape(-1, 32, 32, 3) 
